            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Header/Home</h4>

                                <form class="forms-sample" action="{{url('addHeader')}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="designation" class="form-control" id="exampleInputName1" placeholder="Designation">
                                    </div>
