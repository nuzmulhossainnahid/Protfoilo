                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{url('addPortfolio')}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputName1">Project Name</label>
                                        <input type="text" name="projectName" class="form-control" id="exampleInputName1" placeholder="Name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="projectLink" class="form-control" id="exampleInputName1" placeholder="Project Link">
                                    </div>
                                    <div class="form-group">
