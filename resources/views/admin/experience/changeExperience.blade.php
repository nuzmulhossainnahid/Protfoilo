            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Experience Section</h4>

                                <form class="forms-sample" action="{{url('editExperienceFrom',$data->id)}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control" id="exampleInputName1" value="{{$data->address}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Post</label>
                                        <input type="text" name="post" class="form-control" id="exampleInputName1" value="{{$data->post}}">
                                    </div>
                                    <div class="form-group">
