                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{url('editSkillFrom',$data->id)}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputName1">Skill Name</label>
                                        <input type="text" name="skillName" class="form-control" id="exampleInputName1" value="{{$data->skillName}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Percentage</label>
                                        <input type="number" name="percentage" class="form-control" id="exampleInputName1" value="{{$data->percentage}}">
                                    </div>
