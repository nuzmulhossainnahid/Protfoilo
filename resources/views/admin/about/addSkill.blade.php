            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Skill Section</h4>

                                <form class="forms-sample" action="{{url('addSkillFrom')}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputName1">Skill Name</label>
                                        <input type="text" name="skillName" class="form-control" id="exampleInputName1" placeholder="Skill Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Percentage</label>
                                        <input type="number" name="percentage" class="form-control" id="exampleInputName1" placeholder="Percentage">
                                    </div>
