            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Services Section</h4>

                                <form class="forms-sample" action="{{url('editServicesFrom',$data->id)}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputName1">Name of the Services</label>
                                        <input type="text" name="nameOfServices" class="form-control" id="exampleInputName1" value="{{$data->nameOfServices}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Discription</label>
                                        <textarea name="discription" class="form-control" id="" cols="30" rows="10">{{$data->discription}}</textarea>
